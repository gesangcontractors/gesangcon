export const features = [
  {
    ...
    caption: "JABODETABEK",
    title: "Free Ongkir + Installation",
    text: "Khusus untuk Pemesanan Daerah Jabodetabek, Kita memberikan gratis ongkir dan pemasangan dengan ketentuan PO barang yang sudah di sepakati sebelumnya.",
    button: {
      icon: "/images/meeting1.png",
  ...
  },
  {
    ...
    caption: "LUAR JABODETABEK",
    title: "Packing Kayu + Video Pemasangan",
    text: "Pengirimaan Luar Jabodetabek kita kirim menggunakan Full Packing Kayu, Serta video lengkap setting & Pemasangan, Untuk Mempermudah Customer.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "Semua Barang Furniture ini Ready Stock / PO?",
    answer:
      "Semua Barang Furniture kami PreOrder sesuai dengan kesepakatan kami dengan customer sebelumnya, dan untuk pengiriman Luar JABODETABEK, jika terjadi kemunduran waktu terkait PO akibat pengiriman, bukanlah kesalahan kami, tapi kami akan bantu follow up ke Logistik.",
  },
  {
    id: "1",
    question: "Apakah bisa custom design atau ukuran meja?",
    answer:
      "Ya, kami melayani permintaan custom sesuai kebutuhan klien, termasuk ukuran, warna, dan bahan. Silakan hubungi tim kami via WA atau Marketplace untuk konsultasi.",
  },
  {
    id: "2",
    question: "Apakah tersedia layanan pengiriman dan pemasangan?",
    answer:
      "Tersedia. Kami menyediakan layanan pengiriman dan pemasangan di area Jabodetabek. Untuk wilayah luar Jabodetabek, kami bekerja sama dengan jasa ekspedisi Cargo yang tersedia di Marketplace. lalu kami mengirimkan Paket Secara terpisah / part. serta, kami buatkan video cara pemasangan Meja",
  },
  {
    id: "3",
    question: "Berapa lama waktu pengiriman setelah pemesanan?",
    answer:
      "Untuk produk ready stock, pengiriman dilakukan dalam 2–5 hari kerja. Untuk produk custom, waktu pengiriman tergantung pada durasi produksi.",
  },
  {
    id: "4",
    question: "Apakah ada garansi untuk produk?",
    answer:
      "Ya, semua produk kami bergaransi 1 tahun untuk kerusakan pabrik, seperti cacat produksi atau kerusakan struktur. tapi untuk kerusakan akibat pengiriman / kurir. kami sarankan untuk mengaktifkan asuransi ketika order, agar mudah di klaim jika ada kerusakan akibat pengiriman",
  },
  {
    id: "5",
    question: "Bahan apa yang digunakan untuk furniture kantor Anda?",
    answer:
      "Kami menggunakan bahan berkualitas seperti Multiplek, Blockboard, HPL TACO, dan untuk meja meeting kaki besi, kami menggunakan galvaniz serta Finishing Cat Semprot Propan (lebih rekat & kuat) untuk ketahanan dan tampilan yang premium.",
  },
  {
    id: "6",
    question: "Apakah bisa pesan dalam jumlah besar untuk proyek kantor?",
    answer:
      "Tentu saja. Kami siap melayani pengadaan furniture dalam jumlah besar untuk proyek kantor, co-working space, hingga sekolah.",
  },
  {
    id: "7",
    question: "Bagaimana cara memesan produk?",
    answer:
      "Anda bisa memesan melalui marketplace resmi kami, atau langsung menghubungi tim kami via WhatsApp untuk konsultasi dan pemesanan.",
  },
  {
    id: "8",
    question: "Bagaimana Cara saya tau progress pengerjaan meja saya?",
    answer:
      "Progress pengerjaan meja akan di kirimkan oleh admin kami, progress dikirimkan dalam bentuk foto ataupun video.",
  },
  {
    id: "9",
    question: "Bagaimana metode pembayarannya?",
    answer:
      "Kami menerima semua pembayaran yang tersedia di marketplace, untuk pemesanan secara langsung, kami menerima pembayaran menggunakan Transfer Bank, E-Wallet, dengan opsi DP.",
  },
];
...
export const testimonials = [
  {
    id: "0",
    name: "melissa_tiffanii87",
    role: "Tokopedia",
    avatarUrl: "/images/kontak.png",
    comment:
      "Meja direksi yang kami beli benar-benar meningkatkan kesan profesional di ruang pimpinan. Kualitas mantap dan finishing nya rapih banget.",
  },
  {
    id: "1",
    name: "divaa.lia33",
    ...
    avatarUrl: "/images/kontak.png",
    comment:
      "Meja resepsionisnya oke banget, Tukang yang instalasi juga ramah-ramah, Semoga Awet ya pak barangnya, terimakasih...",
  },
  {
    id: "2",
    name: "indra_shptr130",
    ...
    avatarUrl: "/images/kontak.png",
    comment:
      "Furniture kantor dari toko ini benar-benar berkualitas. Pengiriman tepat waktu dan semua barang datang dalam kondisi sempurna.",
  },
  {
    id: "3",
    name: "edwin_2",
    ...
    avatarUrl: "/images/kontak.png",
    comment:
      "Meja meeting baru kami sangat nyaman dipakai dan bisa menampung banyak orang. Desainnya juga modern, cocok dengan tema kantor.",
  },
  {
    id: "4",
    name: "mr.yahya_22",
    ...
    avatarUrl: "/images/kontak.png",
    comment:
      "Kami suka dengan desain ruang kantor modern yang ditawarkan. Praktis, ergonomis, dan membuat tim kami lebih produktif.",
  },
  {
    id: "5",
    name: "dev_jakbar",
    ...
    avatarUrl: "/images/kontak.png",
    comment:
      "Desain meja direksi sangat mewah dan nyaman digunakan untuk bekerja berjam-jam. Finishing-nya halus dan terlihat premium.",
  },
];
...
export const galleryProducts = [
  {
    ...
    description: "Produk custom yang dipesan oleh Customer XYZ",
  },
  {
    id: 2,
    title: "Meja Receptionist",
    image: "/images/gallery/2.jpeg",
    description: "Design eksklusif untuk Customer ABC",
  },
  {
    id: 3,
    title: "Meja Meeting",
    image: "/images/gallery/3.jpg",
    description: "Pesanan spesial untuk acara ulang tahun",
  },
  {
    id: 4,
    title: "Meja Receptionist",
    image: "/images/gallery/4.jfif",
    description: "Project kolaborasi dengan Customer DEF",
  },
  {
    id: 5,
    title: "Meja Direksi",
    image: "/images/gallery/5.jpg",
    description: "Pesanan khusus untuk event corporate",
  },
  {
    id: 6,
    title: "Meja Receptionist",
    image: "/images/gallery/6.jfif",
    description: "Design eksklusif untuk wedding ceremony",
  },
  {
    id: 7,
    title: "Meja Receptionist",
